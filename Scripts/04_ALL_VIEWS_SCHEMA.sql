-- =============================================
-- TÜM VIEW'LAR - SCHEMA ORGANİZE EDİLMİŞ VERSİYON
-- =============================================
-- Bu dosya tüm view'ları report schema'sında oluşturur
...
PRINT '========================================';
PRINT 'TÜM VIEW''LAR OLUŞTURULUYOR...';
PRINT '========================================';
PRINT '';
...
SELECT 
    ...
    -- Seyahat Sayıları (func schema function kullanımı)
    ...
    (SELECT COUNT(*) 
     ...
     WHERE R.UserID = U.UserID 
       ...
       AND (R.PaymentStatus = 'Paid' OR EXISTS (SELECT 1 FROM app.Payments P WHERE P.ReservationID = R.ReservationID AND P.Status = 'Completed'))
    ...
    -- Ortalama Fiyat (func schema function kullanımı)
    [func].fn_Ortalama_Seyahat_Fiyati(U.UserID) AS OrtalamaSeyahatFiyati,
    
    -- En Çok Gidilen Şehirler (Top 1) - Ödeme yapılmış olanlar
    ...
    -- Son Seyahat Tarihi - Ödeme yapılmış olanlar
    (SELECT MAX(T.DepartureDate)
     FROM app.Reservations R
     INNER JOIN app.Trips T ON R.TripID = T.TripID
     WHERE R.UserID = U.UserID 
       AND R.Status != 'Cancelled' 
       AND (R.PaymentStatus = 'Paid' OR EXISTS (SELECT 1 FROM app.Payments P WHERE P.ReservationID = R.ReservationID AND P.Status = 'Completed'))) AS SonSeyahatTarihi,
...
INNER JOIN app.Cities F ON Trip.FromCityID = F.CityID -- Nereden
INNER JOIN app.Cities T ON Trip.ToCityID = T.CityID -- Nereye
...
-- =============================================
-- 11. vw_Bekleyen_Iptaller
-- =============================================
PRINT '11. vw_Bekleyen_Iptaller oluşturuluyor...';
...
-- =============================================
-- 12. vw_Admin_Dashboard_Ozet
-- =============================================
PRINT '12. vw_Admin_Dashboard_Ozet oluşturuluyor...';
...
-- =============================================
-- 13. vw_Admin_Gunluk_Finansal_Rapor
-- =============================================
PRINT '13. vw_Admin_Gunluk_Finansal_Rapor oluşturuluyor...';
...
PRINT '========================================';
PRINT '';
PRINT 'Oluşturulan View''lar (report schema):';
PRINT '  1. vw_Admin_Dashboard_Istatistikleri';
PRINT '  2. vw_Admin_Rezervasyonlar';
PRINT '  3. vw_Admin_Seferler';
PRINT '  4. vw_Sirket_Istatistikleri';
PRINT '  5. vw_Sirket_Seferleri';
PRINT '  6. vw_Kullanici_Istatistikleri';
PRINT '  7. vw_Bilet_Detay';
PRINT '  8. vw_Sefer_Detaylari';
PRINT '  9. vw_Guzergah_Ciro_Raporu';
PRINT '  10. vw_Tum_Lokasyonlar_Union';
PRINT '  11. vw_Bekleyen_Iptaller';
PRINT '  12. vw_Admin_Dashboard_Ozet';
PRINT '  13. vw_Admin_Gunluk_Finansal_Rapor';
PRINT '';
